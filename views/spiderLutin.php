...
<div class="col-lg-9">
    ...
    <div class="container">
        <h2 class="text-center mt-3 profilGreen">Talents naturels</h2>
        ...
        <p class="m-2 mb-3"><b>En bref, le spider-lutin n'hésite pas à aider ses proches comme le ferait un lutin pour
                faire plaisir à tous les enfants le jour de noël! Il est toujours là pour les autres. Mais
                attention, il a des limites et si on le pousse trop loin il se transforme en
                araignée piquante!</b>
        </p>
        <h2 class="text-center mt-3 profilGreen">Orientation métier</h2>
