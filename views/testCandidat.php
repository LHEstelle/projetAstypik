...
<body>
    ...
    <body class="">
        ...
        <p>Vous allez passer un test qui nous permettra de définir vos talents. Répondez le plus naturellement possible, sléectionnez la réaction qui vous ressemble le plus.
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="emission" id="emission" value="peterPaon" <?= isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="emission">
                            Vous le convainquez de regarder la même émission que vous
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="emission" id="emission1" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="emission1">
                            Vous refusez catégoriquement
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="emission" id="emission2" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="emission2">
                            Vous acceptez pour lui faire plaisir
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="emission" id="emission3" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="voiture" id="voiture" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="voiture" id="voiture1" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="voiture" id="voiture2" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="voiture2">
                            Vous pensez qu’il doit avoir de bonnes raisons de conduire aussi vite
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="voiture" id="voiture3" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="enfant" id="enfant" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="enfant">
                            Vous ramassez le tout en plaisantant sur la vivacité des petits
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="enfant" id="enfant1" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="enfant1">
                            Vous êtes gêné et ramassez rapidement ce qu’il a fait tomber
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="enfant" id="enfant2" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="enfant" id="enfant3" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="vacances" id="vacances" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="vacances" id="vacances1" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="vacances1">
                            Vous prenez en main l’organisation d’un voyage lointain
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="vacances" id="vacances2" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="vacances" id="vacances3" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="embouteillage" id="embouteillage" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="embouteillage">
                            Vous fulminez et cherchez immédiatement un moyen de contourner le bouchon
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="embouteillage" id="embouteillage1" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="embouteillage" id="embouteillage2" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="embouteillage" id="embouteillage3" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="medecin" id="medecin" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="medecin">
                            Vous lui donnez le maximum d’informations même si c’est un peu en vrac
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="medecin" id="medecin1" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="medecin" id="medecin2" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="medecin" id="medecin3" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="restaurant" id="restaurant" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="restaurant" id="restaurant1" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="restaurant" id="restaurant2" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="restaurant2">
                            Vous patientez car la serveuse fait tout ce qu’elle peut
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="restaurant" id="restaurant3" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="sdb" id="sdb" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="sdb">
                            Suivant l’emploi du temps de chacun, vous organisez un ordre de passage logique
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="sdb" id="sdb1" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="sdb1">
                            Vous occupez en premier la SDB, c’est vous le plus rapide et pressé
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="sdb" id="sdb2" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="sdb2">
                            Vous attendez que la SDB se libère
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="sdb" id="sdb3" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto" value="IronSpoke" <?=  isset($_POST["emission"])=="IronSpoke" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto1" value="peterPaon" <?=  isset($_POST["emission"])=="peterPaon" ? 'checked' : '' ?>>
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto2" value="Cactus" <?=  isset($_POST["emission"])=="Cactus" ? 'checked' : '' ?>>
                        <label class="form-check-label" for="loto2">
                            Vous montez votre entreprise, c’est l’occasion rêvée
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto3" value="SpiderLutin" <?=  isset($_POST["emission"])=="SpiderLutin" ? 'checked' : '' ?>>
...
<?php if(isset($arrayAnswer)){ ?>
    <div class="mb-3">
                    ...
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto" value="IronSpoke" <?= isset($key)=="IronSpoke" ? 'checked' : 'disabled' ?>>
                        <label class="form-check-label" for="loto">
                        Rigoureux, précis
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto1" value="peterPaon" <?= isset($key)=="peterPaon" ? 'checked' : 'disabled' ?>>
                        <label class="form-check-label" for="loto1">
                        Enthousiaste, plein d’humour
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto2" value="Cactus" <?= isset($max)>=isset($value)&&isset($key)!="Cactus" ? 'disabled' : '' ?>>
                        <label class="form-check-label" for="loto2">
                        Rapide, décidant facilement
                        </label>
                    </div>
                    <div class="form-check d-flex ms-3">
                        <input class="form-check-input me-3" type="radio" name="loto" id="loto3" value="SpiderLutin" <?= isset($max)>=isset($value)&&isset($key)!="SpiderLutin" ? 'disabled' : '' ?>>
                        <label class="form-check-label" for="loto3">
