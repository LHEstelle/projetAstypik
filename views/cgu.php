...
<body>
    ...
    <div class="container">
        ...
        <p>
            ...
            astypik.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes
            CGU.
        </p>
        <h2> ARTICLE 1 : Les mentions légales </h2>
        <p>
            L’édition et la direction de la publication du site astypik.fr est assurée par Patry Estelle, domicilié 203
            rue Maryse Bastie.
        ...
        <p>
            Le site astypik.fr permet à l'Utilisateur un accès gratuit aux services suivants :
            Le site internet propose les services suivants :
            POUR LES RECRUTEURS :
            -s'inscrire
            -se connecter
            -éditer son profil
            -créer une annonce, la modifier et la supprimer
            -voir les candidats, aimer les profils et obtenir leurs coordonnées si le candidat a également aimé leur
            profil
            -voir la liste des candidats likés
            -se déconnecter
            ...
            -se connecter
            -éditer son profil
            -voir la liste des annonces des recruteurs, aimer les annonces et obtenir les coordonnées du recruteur
            si ce dernier a aimé leur profil
            -voir la liste des annonces aimées
            -se déconnecter
            -supprimer son compte
            ...
            la responsabilité de astypik.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur
        ...
        <p>
            ...
            2
            La marque Astypik est une marque déposée par Estelle Patry.Toute représentation et/ou reproduction
        ...
        <p>
            Les sources des informations diffusées sur le site astypik.fr sont réputées fiables mais le site ne
            ...
            Malgré des mises à jour régulières, le site astypik.fr ne peut être tenu responsable de la modification
            ...
            Le site astypik.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
        ...
        <p>
            ...
            liens, il sortira du site astypik.fr. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
        ...
        <p>
            ...
            l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site astypik.fr. Les cookies ne
            ...
            L’information contenue dans les cookies est utilisée pour améliorer le site astypik.fr.
        ...
        <p>
            ...
            annonces pour les recruteurs, description personnelle pour les candidats.
